...
const GraphicIyE = ({ efectivo = 0, transferencia = 0 }) => {
  ...
  useEffect(() => {
    ...
    const options = {
      series: total === 0 ? [0.01] : [efectivoNum, transferenciaNum],
      chart: {
        type: 'pie',
        width: total === 0 ? 200 : 380,
      ...
      colors: total === 0 ? ['#008FFB'] : ['#4caf50', '#008FFB'],
      annotations: {
        position: 'front',
        yaxis: total === 0 ? [{
          y: 0,
