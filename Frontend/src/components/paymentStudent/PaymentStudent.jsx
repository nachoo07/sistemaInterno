...
import {
  FaBars, FaTimes, FaUsers, FaBell, FaMoneyBill, FaChartBar, FaExchangeAlt,
  FaCalendarCheck, FaUserCog, FaCog, FaEnvelope, FaHome, FaArrowLeft, FaEdit,
  FaTrash, FaPlus, FaSearch, FaSun, FaMoon, FaUserCircle, FaChevronDown, FaTimes as FaTimesClear
} from 'react-icons/fa';
              ...
              <div className="dashboard-sidebar">
                ...
                <div className="payment-summary">
                  ...
                  <div className="summary-content">
                    <p><strong>Total Pagado:</strong> ${totalPaid.toLocaleString('es-ES')}</p>
                    <p><strong>Pagos Registrados:</strong> {payments.length}</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="modal-overlay">
          <div className="content-modal">
            <div className="modal-header">
              ...
              <button className="modal-close" onClick={handleCloseModal} aria-label="Cerrar modal">
                <FaTimes />
              </button>
            </div>
              ...
              <form onSubmit={handleSubmit} className="payment-form">
                <div className="form-row full-width">
                  ...
                  >
                    ...
                    {editMode && formData.concept && !concepts.some(c => c.name === formData.concept) && (
